...
const Deliveries = () => {
    ...
    const getOrders = async () => {
        return await fetch(`https://onlineshopdeliveryapi20220402003022.azurewebsites.net/api/orders/DriverOrders/${driver}`).then( (response) => response.json()).then( (responseJson) => {
